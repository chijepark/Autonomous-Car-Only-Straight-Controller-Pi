...
(cl:defmethod cl:initialize-instance :after ((m <MsgControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name control_esc_v3-msg:<MsgControl> is deprecated: use control_esc_v3-msg:MsgControl instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <MsgControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_esc_v3-msg:data-val is deprecated.  Use control_esc_v3-msg:data instead.")
  (data m))
